...
*Demonstration of how to install an Nginx load balancer server and configure an SSL/TLS digital certificate using HTTPS protocol to the load balancer server for end-to-end security. Additionally, we will register a new DNS name.* 
