...
*Demonstration of how to install an Nginx load balancer server and configure an SSL/TLS digital certificate by implementing HTTPS protocol to the load balancer for end-to-end encryption between users and servers. Additionally, we will register a new DNS name.* 
